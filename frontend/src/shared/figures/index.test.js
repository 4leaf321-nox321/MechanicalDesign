 ...
 * 하다) 한 벌로 돌려쓸 수가 없다. 그래서 하나씩 적는다.
 *
 * 적는 값이 두 가지 일을 한다. 도해가 **실제 값으로도 그려지는지** 보고, 값이
 * 있을 때만 나오는 말글까지 검사한다 — 값이 없을 때만 보면 그런 말글은 시험을
 * 그냥 통과한다. 새 도해를 넣으면 여기도 채워야 하도록 아래에서 못을 박는다.
 */
const SAMPLE = {
